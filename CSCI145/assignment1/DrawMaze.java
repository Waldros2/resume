...
public class DrawMaze {
   ...
   {
      int h = cellsize * 1 + 1 + 2 * borderwidth;
      int w = cellsize * 3 + 1 + 2 * borderwidth;
      ...
      g.drawLine(cellleft(0), celltop(0), cellleft(3), celltop(0));
      g.drawLine(cellleft(0), celltop(0), cellleft(0), celltop(1));
      g.drawLine(cellleft(0), celltop(1), cellleft(3), celltop(1));
      g.drawLine(cellleft(3), celltop(0), cellleft(3), celltop(1));
